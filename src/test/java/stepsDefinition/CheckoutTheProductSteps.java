...
public class CheckoutTheProductSteps extends DriverManager {
    ...
    @Then("User write his information {}, {}, {}")
    ...
    public void user_verify_that_the_checkout_preview_page_is_visible() {
        checkoutPage.verifyIfCheckoutOverviewPageIsVisible();
    }

    @And("User click finish button to checkout the product")
    public void user_click_finish_button_to_checkout_the_product() {
